 ...
 */
export type PostApiAuthSignout400 = {
 ...
 */
export type PostApiAuthSignout500 = {
  result?: unknown | undefined
  /**
   * @type object
   */
...
export type PostApiAuthSignoutMutationResponse = PostApiAuthSignout200

export type PostApiAuthSignoutMutation = {
  Response: PostApiAuthSignout200
  Errors: PostApiAuthSignout400 | PostApiAuthSignout500
}