...
import { OneCategoriesDetails } from "./OneCategoriesDetails";

interface OneCategoriesPageProps {
}

export function OneCategoriesPage({}: OneCategoriesPageProps) {
  return (
